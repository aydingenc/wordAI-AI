...
const styles = StyleSheet.create({
  ...
  flowLabel: { marginTop: 7, color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 12, lineHeight: 15, textAlign: 'center' },
  ...
  quoteText: { flex: 1, color: '#FFFFFF', fontFamily: 'Inter_700Bold', fontSize: 12, lineHeight: 18 },
  quoteAccent: { color: TOKENS.violet100 },
  bookWrap: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', shadowColor: '#8B5CF6', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.32, shadowRadius: 12 },
