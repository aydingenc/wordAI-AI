...
const styles = StyleSheet.create({
  ...
  featureCard: { flex: 1, display: 'flex', flexDirection: 'column', padding: 9, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(167,139,250,0.22)', shadowColor: '#FFFFFF', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 0, minWidth: 0 },
  iconCircle: { width: 26, height: 26, flexShrink: 0, borderRadius: 13, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 6, shadowColor: '#8B5CF6', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.45, shadowRadius: 14, elevation: 8 },
