    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <GlowCard padded={false} style={styles.uploadCard}>
          ...
          <LinearGradient colors={['rgba(167,139,250,0.16)', 'rgba(21,17,31,0.58)', 'rgba(10,7,20,0.93)']} style={StyleSheet.absoluteFill} />
        ...
        <Pressable onPress={() => router.push('/image-analysis-loading')} style={({ pressed }) => [styles.ctaWrap, { opacity: pressed ? 0.84 : 1, transform: [{ scale: pressed ? 0.99 : 1 }] }]}>
...
const styles = StyleSheet.create({
  ...
  robotGlow: { position: 'absolute', left: 0, top: 0 },
  sparkleA: { position: 'absolute', top: 2, right: 14, color: UI.accent, fontSize: 18 }, sparkleB: { position: 'absolute', top: 18, left: 8, color: UI.accent, fontSize: 18 },
  robotHead: { width: 66, height: 58, borderRadius: 24, padding: 7, alignItems: 'center', justifyContent: 'center' },
  robotFace: { width: 48, height: 31, borderRadius: 15, backgroundColor: '#0A0714', alignItems: 'center', justifyContent: 'center' },
  robotEyes: { color: '#FFFFFF', fontSize: 15, lineHeight: 15 }, robotMouth: { color: '#FFFFFF', fontSize: 17, lineHeight: 17 },
  robotBody: { width: 50, height: 38, borderRadius: 17, backgroundColor: 'rgba(139,92,246,0.44)', borderWidth: 1, borderColor: UI.borderStrong, alignItems: 'center', justifyContent: 'center', marginTop: -2 },
  photoMock: { position: 'absolute', width: 40, height: 31, borderRadius: 5, borderWidth: 1, borderColor: UI.accent, backgroundColor: 'rgba(124,58,237,0.42)' }, photoOne: { left: 9, top: 45, transform: [{ rotate: '-15deg' }] }, photoTwo: { right: 7, top: 59, transform: [{ rotate: '14deg' }] }, photoThree: { left: 38, bottom: 5, transform: [{ rotate: '4deg' }] },
  tabs: { flexDirection: 'row', borderRadius: 999, borderWidth: 1, borderColor: UI.border, backgroundColor: UI.card, padding: 4, gap: 4 }, tabButton: { flex: 1 }, activeTab: { minHeight: 52, borderRadius: 999, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingHorizontal: 8 }, activeTabText: { color: '#FFFFFF', fontFamily: 'Inter_700Bold', fontSize: 14.5 }, stepNo: { color: '#FFFFFF', fontFamily: 'Inter_700Bold', fontSize: 16 }, inactiveTab: { minHeight: 52, borderRadius: 999, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingHorizontal: 8 }, inactiveTabText: { fontFamily: 'Inter_600SemiBold', fontSize: 14.5 }, tabCircle: { width: 28, height: 28, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, tabCircleText: { fontFamily: 'Inter_700Bold', fontSize: 13 },
  uploadCard: { minHeight: 292, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', padding: 18, borderRadius: 24, borderWidth: 0, borderColor: 'transparent', backgroundColor: UI.card }, uploadDash: { ...StyleSheet.absoluteFillObject, borderWidth: 1.6, borderColor: UI.borderStrong, borderStyle: 'dashed', borderRadius: 24, zIndex: 5 }, balloon: { position: 'absolute', right: 35, top: 62 }, iconOrb: { width: 58, height: 58, borderRadius: 29, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: UI.borderStrong }, iconOrbLarge: { width: 78, height: 78, borderRadius: 39, marginBottom: 8 }, uploadTitle: { color: UI.white, fontFamily: 'Inter_700Bold', fontSize: 18 }, uploadDesc: { color: UI.muted, fontFamily: 'Inter_400Regular', fontSize: 14, lineHeight: 20, textAlign: 'center', marginTop: 5 }, actionRow: { flexDirection: 'row', gap: 14, marginTop: 12, width: '100%' }, uploadAction: { flex: 1, minHeight: 78, borderRadius: 18, borderWidth: 1, borderColor: UI.border, backgroundColor: 'rgba(21,17,31,0.84)', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 14, paddingHorizontal: 12 }, actionTitle: { color: UI.white, fontFamily: 'Inter_700Bold', fontSize: 16 }, actionSubtitle: { color: UI.muted, fontFamily: 'Inter_400Regular', fontSize: 13, marginTop: 4 },
