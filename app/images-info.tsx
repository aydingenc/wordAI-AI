...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 28, height: 28, flexShrink: 0, borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 8, shadowColor: '#8B5CF6', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.45, shadowRadius: 14, elevation: 8 },
  iconSvg: { width: 15, height: 15 },
  featureHeadTitle: { margin: 0, marginBottom: 6, fontSize: 10.5, fontFamily: 'Inter_700Bold', lineHeight: 13.65, letterSpacing: -0.1, color: '#fff' },
  featureCardText: { margin: 0, fontSize: 10.5, fontFamily: 'Inter_400Regular', lineHeight: 15.225, color: '#A19DB0', width: '100%' },
